describe('Blog app', function () {
    ...
    describe('When logged in', function () {
      ...
      it('A blog can be liked', function () {
        // Verifica que el botón de "View" o "Show" está visible y haz clic en él
        cy.contains('My Cypress Blog Cypress Tester').parent().find('button').as('viewButton')
        cy.get('@viewButton').click()
  
        // Verifica que el blog tiene inicialmente 0 likes
        cy.contains('likes 0')
  
        // Haz clic en el botón de "like" y verifica que los likes aumentan
        cy.get('@viewButton').parent().contains('like').click()
  
        // Verifica que los likes aumentan
        cy.contains('likes 1')
      })
    })
  })
